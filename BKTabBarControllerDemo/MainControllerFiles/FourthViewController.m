...
- (void)viewDidLoad
{
    ...
    [backgroundImageView setImage:[UIImage imageNamed:@"ImageOfTheElderScrolls04"]];
...
- (void)mainBtnAction
{
    ...
    nextViewCtl.title = @"[我的]第二控制器";
    nextViewCtl.view.backgroundColor = [UIColor yellowColor];
    UIImageView *backgroundImageView = [[UIImageView alloc] init];
    backgroundImageView.frame = CGRectMake(0, HeadHeight + NavigationItemHeight, ScreenWidth, ScreenHeight - HeadHeight - NavigationItemHeight);
    [backgroundImageView setImage:[UIImage imageNamed:@"ImageOfTheElderScrolls08"]];
